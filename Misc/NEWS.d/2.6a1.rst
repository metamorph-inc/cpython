...
renamed THREADDEBUG envvar to OMPYTHONTHREADDEBUG.
...
Add -B command line option, OMPYTHONDONTWRITEBYTECODE envvar and
...
the warning module prints much more sensible when a OMPYTHONSTARTUP file is
used.
...
option or OMPYTHONINSPECT environment variable is given, but break into the
