...
environment variable.  :envvar:`OMPYTHONUSERBASE` sets the root
...
:option:`-s` option or setting the :envvar:`OMPYTHONNOUSERSITE`
...
or by setting the :envvar:`OMPYTHONDONTWRITEBYTECODE` environment
...
be specified by setting the :envvar:`OMPYTHONIOENCODING` environment
...
* A new variable in the :mod:`sys` module, :attr:`float_info`, is an
  ...
  :envvar:`OMPYTHONDONTWRITEBYTECODE` environment variable before
